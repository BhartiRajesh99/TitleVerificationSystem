          ...
          <div className="flex flex-col gap-4 text-sm font-medium">
            ...
            {isAuthenticated && (
              <>
                ...
                <NavItem to="/verify" onClick={() => setOpen(false)}>Verify</NavItem>
                <NavItem to="/history" onClick={() => setOpen(false)}>History</NavItem>
                {role === "admin" && (
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl border border-indigo-600 text-indigo-600 text-sm font-semibold"
              >
                Sign Up
              </button>
            </div>
